...
- (NSArray *)viewControllers {
    ...
    UINavigationController *exploreNaviVC = [[UINavigationController alloc] initWithRootViewController:exploreVC];
    
    ProfileViewController *profileVC = [[ProfileViewController alloc] init];
    UINavigationController *profileNaviVC = [[UINavigationController alloc] initWithRootViewController:profileVC];
